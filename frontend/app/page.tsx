...
const TABS=[{id:"predict" as Tab,label:"🏠 Predict"},{id:"compare" as Tab,label:"⚖️ Compare"},
            {id:"trends" as Tab,label:"📈 Trends"},{id:"history" as Tab,label:"🕒 History"}];
          ...
          <div className="flex flex-col xl:flex-row" style={{minHeight:"calc(100vh - 112px)"}}>
            ...
            <div className="xl:w-[60%] overflow-y-auto p-5 space-y-5">
              ...
              {modelStats&&Object.keys(modelStats).length>0&&(
                <div className="bg-white border border-charcoal/10 shadow-sm">
                  <div className="bg-charcoal px-5 py-2.5"><span className="font-mono text-xs uppercase tracking-widest text-sand">Model Accuracy</span></div>
